...
class AdminController extends Controller
{
    ...
    /**
     * Daily Quest Templates - List
     */
    public function questTemplatesIndex()
    {
        $templates = DailyQuestTemplate::orderBy('day_of_week')->get();
        return view('admin.quests.templates', compact('templates'));
    }

    /**
     * Daily Quest Templates - Edit
     */
    public function questTemplatesEdit(DailyQuestTemplate $template)
    {
        return view('admin.quests.template-edit', compact('template'));
    }

    /**
     * Daily Quest Templates - Update
     */
    public function questTemplatesUpdate(Request $request, DailyQuestTemplate $template)
    {
        $validated = $request->validate([
            'title' => 'required|string|max:255',
            'description' => 'required|string',
            ...
            'reward_coins' => 'required|integer|min:0|max:10000',
        ]);
    ...
    /**
     * Initialize Default Daily Quest Templates
     */
    public function questTemplatesInitialize()
    {
        $defaults = [
            [
        ...
        return redirect()->route('admin.quest-templates.index')
                        ->with('success', 'Default daily quest templates initialized successfully.');
    }
}
