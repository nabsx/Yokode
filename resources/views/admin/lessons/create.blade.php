...
@section('subtitle', 'Add a new lesson to the platform')

@section('content')
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-bold text-gray-800">Create New Lesson</h3>
        </div>

        <form action="{{ route('admin.lessons.store') }}" method="POST" class="p-6" enctype="multipart/form-data">
            @csrf
